    ...
    <transition name="list-fade">
        <div class="playlist" v-show="showFlag" @click="hide">
            <div class="list-wrapper" @click.stop>
                ...
                <base-scroll class="list-content" :data="sequenceList" ref="listContent">
            ...
            <confirm ref="confirm" text="是否增加播放列表" confirmBtnText="清空" @confirm="confirmClear"></confirm>
    ...
    .list-wrapper {
        ...
        .list-operate {
            ...
            .add {
                ...
                .text { font-size: @font-size-small; }
            }
        }
        .list-close {
            text-align: center;
